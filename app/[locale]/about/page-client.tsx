...
export default function AboutPageClient({ pageContent, pageBanner, teamMembers = [], locale }: AboutPageProps) {
  const t = useTranslations('about');

  // Use Sanity content only
                    ...
                    <div className="pt-12 border-t border-gray-200">
                      ...
                      <div className="space-y-12">
                        {teamMembers.map((member, index) => {
                          ...
                          return (
                            <div key={member._id} className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
