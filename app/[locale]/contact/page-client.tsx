                    ...
                    <PortableText 
                      ...
                      components={{
                        block: {
                          ...
                          bullet: ({ children }: any) => (
                            <ul className="list-disc list-outside mb-4 space-y-2 text-base text-foreground leading-relaxed font-light pl-6">
                              {children}
                            </ul>
                          ),
                          number: ({ children }: any) => (
                            <ol className="list-decimal list-outside mb-4 space-y-2 text-base text-foreground leading-relaxed font-light pl-6">
                              {children}
                            </ol>
                          ),
                        },
